...
import {hasBillingAccess,planFromPriceIds,storefrontQuantity} from "../src/lib/billing";
...
test("Stripe prices determine the authoritative plan",()=>{assert.equal(planFromPriceIds(["price_unlimited"],{standard:"price_standard",unlimited:"price_unlimited"}),"unlimited");assert.equal(planFromPriceIds(["unknown"],{standard:"price_standard",unlimited:"price_unlimited"}),null)});
